...
(function () {
  var portfolioPieceGalleries = document.querySelectorAll(
  ...
  for (index = 0; index < portfolioPieceGalleries.length; index++) {
    ...
    newSectionButtonLeftText = document.createTextNode(
      "View Previous Image (requires CSS)"
    );
    ...
    newSectionButtonRightText = document.createTextNode(
      "View Next Image (requires CSS)"
    );
